...
package com.wpa.theme;

import atlantafx.base.theme.Theme;
import com.wpa.NewLauncher;
import com.wpa.util.FileResource;
...
import static com.wpa.Launcher.IS_DEV_MODE;
import static com.wpa.theme.ThemeManager.*;
import static com.wpa.util.Resources.resolve;
    ...
    public FileResource getResource() {
        ...
        try {
            FileResource testTheme = FileResource.createInternal(
                resolve("theme/" + filename), NewLauncher.class
            );
            if (!testTheme.exists()) {
            ...
            var failedPath = resolve("theme/" + filename);
            System.err.println(
